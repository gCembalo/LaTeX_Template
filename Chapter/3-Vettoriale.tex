...
A noi interessa riordinare gli elementi che troviamo nella matrice $S$ come $\psi\overline{\psi}$, formando il propagatore $S_F(x-y) = \VEV{0}{T[\psi(x) \overline{\psi}]}{0}$, ma per fare questo dobbiamo ricordarci:
\begin{align}
